...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
    ...
    <span class="mb-3 text-lg font-semibold text-blue-500 capitalize">{{ $action }}</span>
    <p class="text-blue-600 text-base font-normal text-pretty leading-relaxed">{{ $message }}</p>
</div>