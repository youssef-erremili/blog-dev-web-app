<footer class="w-full mt-16 bg-gray-50 py-16 border-t border-gray-200">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <!-- Navigation Links -->
            <ul class="flex flex-wrap items-center justify-center gap-6 sm:gap-8 md:gap-12 text-base sm:text-lg mb-12 pb-8 border-b border-gray-200">
                <li><x-nav-link href="/" class="hover:text-gray-600 transition-colors duration-300">home</x-nav-link></li>
                <li><x-nav-link href="/hd" class="hover:text-gray-600 transition-colors duration-300">explore</x-nav-link></li>
                <li><x-nav-link href="/hd" class="hover:text-gray-600 transition-colors duration-300">write</x-nav-link></li>
                <li><x-nav-link href="/hd" class="hover:text-gray-600 transition-colors duration-300">vision</x-nav-link></li>
            </ul>

            <!-- Social Icons -->
            <div class="flex flex-wrap justify-center items-center gap-6 mb-12">
                <!-- Twitter/X -->
                <a href="javascript:;" class="p-3 rounded-lg bg-white shadow-sm border border-gray-200 text-gray-700 hover:text-gray-900 hover:shadow-md transition-all duration-300">
                ...
                <!-- Instagram -->
                <a href="javascript:;" class="p-3 rounded-lg bg-white shadow-sm border border-gray-200 text-gray-700 hover:text-gray-900 hover:shadow-md transition-all duration-300">
                    <svg class="w-5 h-5" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Facebook -->
                <a href="javascript:;" class="p-3 rounded-lg bg-white shadow-sm border border-gray-200 text-gray-700 hover:text-gray-900 hover:shadow-md transition-all duration-300">
                    <svg class="w-4 h-6" viewBox="0 0 15 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- YouTube -->
                <a href="javascript:;" class="p-3 rounded-lg bg-white shadow-sm border border-gray-200 text-gray-700 hover:text-gray-900 hover:shadow-md transition-all duration-300">
                    <svg class="w-7 h-5" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="text-center">
                <span class="text-sm sm:text-base text-gray-500">
                    <a href="/" class="font-medium hover:text-gray-700 transition-colors duration-300">Dev</a> 
