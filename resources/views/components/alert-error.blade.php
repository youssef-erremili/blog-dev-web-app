...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
    ...
    <span class="mb-3 text-lg font-semibold text-red-600 capitalize">{{ $action }}</span>
    <p class="text-red-600 text-base font-normal text-pretty leading-relaxed capitalize">{{ $message }}</p>
</div>