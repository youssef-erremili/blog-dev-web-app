                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-700 bg-red-500 border border-gray-300 cursor-default leading-5">{{ $element }}</span>
                            </span>
                        @endif
