<x-dashboard>
    ...
    <div class="mt-14 border border-gray-200 py-4 px-4 rounded-2xl">
        ...
        <div class="flex justify-between mt-3 w-full">
            <div class="flex flex-wrap justify-evenly items-center w-full overflow-hidden"> 
                <div class="flex items-center rounded-3xl w-[30%] my-4 py-5 px-6 border-2 border-indigo-800 bg-white">
                ...
                <div class="flex items-center rounded-3xl w-[30%] my-4 py-5 px-6 border-2 border-red-500 bg-white">
                ...
                <div class="flex items-center rounded-3xl w-[30%] my-4 py-5 px-6 border-2 border-orange-500 bg-white">
                    <div class="block bg-orange-500 rounded-xl mr-6 py-3 px-3 size-16">
                        <img class="w-full" src="{{ asset('images/analytics-outline.svg') }}" alt="icon">
                    </div>
                    <div>
                ...
                <div class="flex items-center rounded-3xl w-[30%] my-4 py-5 px-6 border-2 border-sky-500 bg-white">
                ...
                <div class="flex items-center justify-self-start rounded-3xl w-[30%] my-4 py-5 px-6 border-2 border-violet-500 bg-white">
            ...
            @if ($users->following->count() !== 0)
                <div class="ml-3 h-fit w-[40%] bg-white py-4 px-4 rounded-2xl border border-gray-200">
