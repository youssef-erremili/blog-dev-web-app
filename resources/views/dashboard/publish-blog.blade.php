<x-layout>
    ...
    <x-form action="{{ route('publish-blog.store') }}">
        ...
        <div class="mt-10 border border-gray-300 rounded-lg py-4 px-10">
            ...
            <div class="mt-6">
                <button type="submit" class="rounded-lg capitalize text-white text-lg py-1.5 inline-block px-10 bg-indigo-600 cursor-pointer border-2 border-white focus:ring focus:ring-indigo-600">publish</button>
            </div>
        </div>
    </x-form>
