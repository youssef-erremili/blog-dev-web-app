    ...
    <x-form action="{{ route('sign-up') }}">
        ...
        <div class="border bg-slate-50 bg-opacity-20 w-2/4 py-10 px-12 mx-auto my-10 rounded-lg shadow-md shadow-gray-100">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="@error('name') border-red-400 border-2 @enderror block w-full h-11 px-5 py-2.5 bg-white leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border-2 border-gray-200 rounded-xl placeholder-gray-400 focus:outline-none " placeholder="Full Name">
                @error('name')
            ...
            <div class="mb-6">
                ...
                <div>
                    ...
                    <input type="file" name="profile_picture" class="block w-full text-sm text-gray-500 border-2 cursor-pointer border-gray-200 rounded-xl
            ...
            <div class="mb-6">
                ...
                <input type="password" name="password_confirmation" class="@error('password') border-red-400 border-2 @enderror block w-full h-11 px-5 py-2.5 leading-7 text-base font-normal shadow-xs text-gray-900 bg-transparent border-2 border-gray-200 rounded-xl placeholder-gray-400 focus:outline-none "
